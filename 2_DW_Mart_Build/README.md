...
- ✅ **Pipeline Scope:** Built a complete *ETL pipeline* from raw CSVs files to a star-schema data warehouse and analytical marts.
...
- **SQL File:**  
  ...
  - [03_create_flat_mart.sql](2_DW_Mart_Build\03_create_flat_mart.sql) – Builds denormalized table with all dimensions joined  
...
## Data Engineering Skill Demonstrated  
