...
The following projects are collection of SQL projects that I have worked on to practice and reinforce my skills w/ data engineering tools.  
> Click the project name below to view the tools I used to build these!   
## Projects

[1. EDA](1/EDA/)  - Exploratory Data Analysis  
...
### [2.WH_Mart_Build](2_DW_Mart_Build) - Data Pipeline - Data Warehouse & Mart   
